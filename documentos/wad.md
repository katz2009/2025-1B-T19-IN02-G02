...
Wireframe é uma representação visual simplificada da interface de um aplicativo, usada para planejar a navegação, a disposição dos elementos e a experiência do usuário.
